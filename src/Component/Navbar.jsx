...
import '../App.css'; // Agar aapko custom styles add karne hain
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#AFDBF5] shadow-md w-full z-50">
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <a href="/" className="flex items-center gap-2 group">
            <img 
              ...
              alt="LearnNov Logo" 
            />
            <span className="text-2xl font-bold text-[#00356B] tracking-tight transition-colors ">
              Learn<span className="text-[#00356B] group-hover:text-[#003262]">Nova</span>
            </span>
          </a>
          ...
          <div className="hidden md:flex space-x-6">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="text-[#000E22] font-medium transition-colors duration-200 px-1 py-2"
              >
                {link.name}
              </a>
            ))}
